                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($resultAgen)) :  ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $no ?></td>
                                                <td><?= $row["nama"] ?></td>
                                                <td><img src="img/agen/<?= $row["foto"] ?>" alt="" class="img-d img-fluid" style="width: 10rem;"></td>
                                                <td><?= $row["no_telp"] ?></td>
                                                <td><?= $row["instagram"] ?></td>
                                                <td>
            ...
            <div class="modal-content">
                ...
                <form action="update.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" name="idAgen" id="idAgen">
                        <input type="hidden" name="fotoLama" id="fotoLama">
                        <div class="form-group">
                            <label for="namaAgen" class="col-form-label">Nama</label>
                            <input type="text" class="form-control" id="namaAgen" name="namaAgen" required>
                        </div>
                        <div class="form-group">
                            <label for="foto" class="col-form-label" style="display:block ;">Foto</label>
                            <div>
                        ...
                        <div class="form-group">
                            <label for="ig" class="col-form-label">Instagram</label>
                            <input type="text" class="form-control" id="ig" name="ig" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        <button type="submit" class="btn btn-primary" id="editAgen" name="editAgen">Simpan</button>
                    </div>
                </form>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="tambah.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="namaAgen" class="col-form-label">Nama Agen</label>
                            <input type="text" class="form-control" id="namaAgen" name="namaAgen">
                        </div>
                        <div class="form-group">
                            <label for="fotoAgen" class="col-form-label" style="display:block ;">Foto</label>
                            <input type="file" id="fotoAgen" name="fotoAgen">
                        </div>
                        <div class="form-group">
                            <label for="noTelp" class="col-form-label">No Telp</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        <button type="submit" class="btn btn-primary" name="inputAgen">Input</button>
                    </div>
                </form>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="hapus.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="delete_idAgen" id="delete_idAgen">
                        Apakah anda yakin ingin menghapusnya?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                        <button type="submit" class="btn btn-primary" name="delAgen" id="delAgen">Yakin</button>
                    </div>
                </form>
